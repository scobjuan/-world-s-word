...
// 	if (quantityLettersOfCurrentWord === 0 || quantityLettersOfCurrentWord < quantityLetters || quantityLettersOfCurrentWord > 7) return false
...
// 		} else {
// 			const position = (currentRow.value * 7) - (7 - i)
...
// 	const nextRow = (currentRow.value * 7) + 1
...
// 		if (column >= 2) position = (column * 7) - (7 - positionsWithCorrectLetter[i])
...
// 		if (column >= 2) position = (column * 7) - (7 - mismatchedLettersPositions[i])
